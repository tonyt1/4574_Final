...
public:
    ...
    {
        RandomFact->setWindowTitle(QApplication::translate("RandomFact", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("RandomFact", "Click the Button Below for a Random Fact. \n"
"Add a subject to narrow random fact", Q_NULLPTR));
        label_2->setText(QApplication::translate("RandomFact", "Subject: ", Q_NULLPTR));
        getfact_but->setText(QApplication::translate("RandomFact", "Get Random Fact", Q_NULLPTR));
        logout_but->setText(QApplication::translate("RandomFact", "Logout", Q_NULLPTR));
    } // retranslateUi
