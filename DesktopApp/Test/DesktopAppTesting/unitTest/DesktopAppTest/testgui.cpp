...
const QString INFO_ERROR = QString("Please Enter a valid Username and Password");
...
private slots:
    void init();
    void cleanup();
    void ClickLogin_NoInfo();
    void ClickLogin_WithInfo();
    void ClickCreate_NoInfo();
...
void TestGui::ClickLogin_NoInfo()
{
    ...
    QVERIFY2(signalcount == 0,"Sent out request with no username or password.");
...
void TestGui::ClickLogin_WithInfo()
{
    ...
    m_LoginUsername->setText("TestLoginUsername");
    m_LoginPassword->setText("TestLoginPassword");
...
void TestGui::ClickCreate_NoInfo()
{
    ...
    int signalcount = executeSignal.count();
    QVERIFY2(signalcount == 0,"Sent out request with no created username or password.");
    CheckErrorMB();
...
void TestGui::ClickCreate_BadInfo()
{
    ...
    m_CreateAccountPassword2->setText("TestCreatePasswordDifferent");
